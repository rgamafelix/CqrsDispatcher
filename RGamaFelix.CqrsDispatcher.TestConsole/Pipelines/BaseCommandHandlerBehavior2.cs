...
public class BaseCommandHandlerBehavior2 : ICommandHandlerBehavior<BaseCommandHandler, BaseCommandRequest>
{
  public int? Order => 0;

  public async Task Handle(BaseCommandRequest request, BaseCommandHandler handler,
